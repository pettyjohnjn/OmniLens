...
PBS_JOBNAME="${PBS_JOBNAME:-llama3_70b_feas_direct}"
MAX_CONCURRENT_RUNS="${MAX_CONCURRENT_RUNS:-1}"
DRY_RUN="${DRY_RUN:-0}"

MODEL_NAME="${MODEL_NAME:-meta-llama/Llama-3.3-70B-Instruct}"
BASE_OUT="${BASE_OUT:-${REPO_DIR}/src/checkpoints/llama3_70b_feasibility_direct_debug}"
STAGING_ROOT="${STAGING_ROOT:-${REPO_DIR}/tmp/llama3_70b_feasibility_direct_debug}"
LOG_SUBDIR="${LOG_SUBDIR:-llama3_70b_feasibility_direct_debug}"
...
LR="${LR:-1e-3}"
TOKENS_PER_STEP="${TOKENS_PER_STEP:-1024}"
...
PER_GPU_MAX_MEMORY="${PER_GPU_MAX_MEMORY:-39GiB}"
...
MANIFEST_FILE="${STAGING_DIR}/manifest.llama3_70b_feasibility_direct_debug.txt"
