...
SERIES = [
    ...
    Series(
        label="LoRA default init, IS 256+256",
        path=EVAL
        / "gpt2_lora_init_is_256x256_r64_debug"
        / "lora_is256x256_r64_default_lora__lens_step_250"
        / "aggregate_metrics.json",
        lens_key="lora",
        color="#ff7f0e",
    ),
    Series(
        label="LoRA ridge init, IS 256+256",
        path=EVAL
        / "gpt2_lora_init_is_256x256_r64_debug"
        / "lora_is256x256_r64_ridge_svd__lens_step_250"
        / "aggregate_metrics.json",
        lens_key="lora",
        color="#2ca02c",
    ),
...
def main() -> None:
    ...
    ax.text(
        0.01,
        0.02,
        "Log y-axis. LoRA runs: r=64, step 250. IS estimator: 256 head + 256 tail. Lower is better.",
