...
class TestSubsetKLLoss:
    ...
    @pytest.mark.parametrize("mode", ["is", "k2", "k3"])
...
class TestHooksReExport:
    """Test that hookbox re-exports work through omnilens.hooks."""

    def test_imports(self):
        from omnilens.hooks import (
            ActivationCollector,
            HookManager,
            ActivationHook,
            BaseHook,
...
class TestOpsWrapper:
    ...
    def test_availability_check(self):
        from omnilens.ops import indexed_logits_available
