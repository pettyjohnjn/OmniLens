# src/omnilens/ops/indexed_logits.py
"""
...
Paper mapping: Sec. 4.3 ('A Fused Kernel for Selected Logits') and the
CUDA appendix; avoids the [B*T, k, d] gathered intermediate quantified
there (68.7 GB fp32 at B*T=8192, k=512, d=4096 vs 0.15 GB fused).
"""
