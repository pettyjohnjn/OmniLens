# src/omnilens/training/trainer.py
"""
...
from omnilens.losses import BaseLoss, SubsetKLLoss
from omnilens.losses.shared_subset_kl import SharedSubsetKLLoss
...
class LensTrainer:
    ...
    def _forward_backward_layerwise(
        ...
        if self._use_subset_kl:
            ...
            # The per-position subset path reads only subset_chunks from here
            # on; holding the [B, T, V] teacher tensor through the layer loop
            # costs a full-vocabulary allocation for nothing.
