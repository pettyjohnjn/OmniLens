# src/omnilens/initialization.py
"""Optional data-driven initialization for low-rank lenses."""
...
from omnilens.lenses.lowrank_lens import LowRankLens
from omnilens.training.activation_sites import ActivationSitePlan
from omnilens.training.distributed import DDPState, all_reduce_sum
from omnilens.training.model_shard import ModelShardState
...
def initialize_lowrank_lens(
    *,
    ...
    """Apply an optional data-driven initialization to a low-rank lens."""
